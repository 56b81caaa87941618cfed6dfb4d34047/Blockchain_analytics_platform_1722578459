...
Vue.component("purple_hero_component_1722578463", {
    template: `
    <section id="hero-section-container" class="bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600">
    <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 backdrop-blur-md bg-white/10 rounded-lg shadow-lg">
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                <div id="announcement-text" class="mb-6" data-aos="fade-down">
                    <div id="announcement-text-inner" class="flex relative before:absolute before:inset-0 before:blur-md before:bg-pink-300/30 rounded-full">
                        <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-white hover:text-pink-200" 
                           href="#0" 
                           style="background: linear-gradient(to right, rgba(236, 72, 153, 0.7), rgba(167, 139, 250, 0.7)) padding-box, linear-gradient(to right, rgba(236, 72, 153, 0.9), rgba(167, 139, 250, 0.9)) border-box;">
                ...
                <div class="flex" id="hero-text-container">
                    <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-pink-200 via-purple-300 to-indigo-200 pb-4 font-bold text-5xl" data-aos="fade-down">Unlock the Power of Blockchain Data</h1>
                </div>
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-white opacity-80" data-aos="fade-down" data-aos-delay="200">Our AI-driven analytics suite provides real-time insights into blockchain transactions and activities.</p>
                </div>
                <div id="buttons-container" class="flex justify-center space-x-4 mt-8">
                    ...
                    <div id="docs-button-container">
                        <a id="docs-button" class="flex items-center justify-center px-6 py-3 text-white bg-white bg-opacity-20 rounded-lg shadow-md transition duration-150 ease-in-out hover:bg-opacity-30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 backdrop-blur-sm" href="#0">
